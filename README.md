...
About
-----
* Minimax-based alpha-beta pruning based next move computation, earlier build using trained on 9 simple CNN layer combined with Relu.
* Data format is serialized data of dimension 8x8x5 bit matrix obtained from PGN chess dataset taken from <a href="https://www.kaggle.com/datasets/ironicninja/raw-chess-games-pgn">kaggle</a>.<br>
